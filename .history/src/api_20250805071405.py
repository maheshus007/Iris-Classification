...
class NewDataSample(BaseModel):
    ...
    species: str = Field(..., description="True species label", regex="^(Iris-setosa|Iris-versicolor|Iris-virginica)$")
...
async def get_data_monitoring_status():
    ...
    try:
        ...
        return DataMonitoringStatus(
            ...
            pending_samples=data_monitoring_state.get("pending_samples", 0),
